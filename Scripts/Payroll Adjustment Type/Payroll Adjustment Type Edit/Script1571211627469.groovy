...
WebUI.click(findTestObject('Object Repository/Payroll Adjustment Types/a_Edit'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('Object Repository/Payroll Adjustment Types/btn_OK'), FailureHandling.STOP_ON_FAILURE)
