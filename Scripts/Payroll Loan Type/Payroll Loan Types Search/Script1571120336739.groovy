...
WebUI.setText(findTestObject('Payroll Loan Type/Payroll Loan Types Search/txt_Search'), 'SSS Calamity Loan')

WebUI.click(findTestObject('Payroll Loan Type/Payroll Loan Types Search/btn_Search'),FailureHandling.STOP_ON_FAILURE)
